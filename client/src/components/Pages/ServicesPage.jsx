      ...
      <section className="py-24 relative overflow-hidden bg-slate-50">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 lg:gap-10 items-stretch">
            ...
            >
              {/* Header Image Area */}
              <div className="h-48 bg-orange-50 relative overflow-hidden flex items-center justify-center group-hover:bg-orange-100 transition-colors duration-500">
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-30"></div>

                {/* Floating Icon */}
                <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center text-orange-600 text-4xl shadow-xl border-4 border-white relative z-10 group-hover:scale-110 transition-transform duration-500">
                  <FaTruckLoading />
                </div>
              </div>
              ...
              <div className="p-8 md:p-12 flex-grow flex flex-col">
                <h3 className="text-3xl font-heading font-bold text-[#00224D] mb-4 text-center group-hover:text-orange-600 transition-colors">
                  Trading Services
                </h3>
            ...
            >
              {/* Header Image Area */}
              <div className="h-48 bg-[#00152e] relative overflow-hidden flex items-center justify-center group-hover:bg-[#001a36] transition-colors duration-500">
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>

                {/* Floating Icon */}
                <div className="w-24 h-24 bg-[#00224D] rounded-full flex items-center justify-center text-white text-4xl shadow-xl border-4 border-[#1a3a63] relative z-10 group-hover:scale-110 transition-transform duration-500 group-hover:border-orange-500">
                  <FaHardHat />
                </div>
              </div>
              ...
              <div className="p-8 md:p-12 flex-grow flex flex-col relative z-10">
                <h3 className="text-3xl font-heading font-bold text-white mb-4 text-center group-hover:text-orange-500 transition-colors">
      ...
      <section className="bg-white py-20 px-6 border-t border-slate-100">
         <div className="container mx-auto text-center">
           ...
           <motion.a
             ...
             whileTap={{ scale: 0.95 }}
             href="/contact"
             className="inline-block bg-orange-600 text-white px-10 py-4 rounded-lg font-bold shadow-lg hover:bg-orange-700 hover:shadow-orange-500/30 transition-all"
           >
             Get a Free Quote
           </motion.a>
         </div>
